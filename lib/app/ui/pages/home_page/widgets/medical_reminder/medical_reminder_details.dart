  ...
  Widget build(BuildContext context) {
    ...
    return MyDialog(
      ...
      child: Column(
        ...
        children: [
          MedicalReminderCard(medicalReminder: widget.medicalReminder),
          ...
          const SizedBox(height: 12),
          if (widget.medicalReminder.dateTime.isAfter(DateTime.now()))
            ExpansionTile(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: MedicalReminderCardEdit(widget.medicalReminder),
                ),
              ],
            ),
        ],
